...
public class CoursesByInstructor extends JFrame {
	private JPanel contentPane;
	private JTextField id;
	/**
	 * Create the frame.
	 */
	public CoursesByInstructor() {
		...
		btnEnter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ArrayList<Course> courses = AdminMenuScreen.controller.coursesByInstructor(Integer.parseInt(id.getText()));
				String data = "";
