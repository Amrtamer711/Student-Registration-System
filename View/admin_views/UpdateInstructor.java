...
public class UpdateInstructor extends JFrame {
	...
	public UpdateInstructor() {
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (idTxt.getText().equals("") || 
						nameTxt.getText().equals("") || passwordTxt.getText().equals("")) {
					JOptionPane.showMessageDialog(null, "Field is empty");
					return;
				}
				Instructor ins = new Instructor(nameTxt.getText(), Integer.parseInt(idTxt.getText()), passwordTxt.getText(), comboBox.getSelectedItem().toString(), AdminMenuScreen.controller.getInstructorLoad(Integer.parseInt(idTxt.getText())));
				if (AdminMenuScreen.controller.modifyInstructor(Integer.parseInt(idTxt.getText()), ins)) {
		...
		JLabel lblNewLabel_1 = new JLabel("Update Instructor");
